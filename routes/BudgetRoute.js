...
router.post('/createBudget', async (req, res) => {
    try {
        let { name, totalAmount, startDate, endDate, categories } = req.body.budget;
...
// /addCategoryToBudget
router.post('/CreateBudgetCategory', async (req, res) => {
    try {
...
// /addBudget
router.post('/CreateInitialBudget', async (req, res) => {
    try {
